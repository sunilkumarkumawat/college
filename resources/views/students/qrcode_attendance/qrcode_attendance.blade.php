...
<div class="content-wrapper">
    	...
    	<link rel="stylesheet" href="https://ramomcoder.com/saas/assets/css/qr-code.css">
<script type="text/javascript" src="https://ramomcoder.com/saas/assets/vendor/qrcode/qrcode.min.js"></script>
<script type="text/javascript" src="https://ramomcoder.com/saas/assets/js/qrcode_attendance.js"></script>
	<!-- ramom css -->
<audio id="in">
  <source src="https://demo3.rusoft.in/public/qrcode_voice/in.mp3" type="audio/ogg">
</audio>
<audio id="out">
  <source src="https://demo3.rusoft.in/public/qrcode_voice/out.mp3" type="audio/ogg">
</audio>
<audio id="duplicatePunch">
  <source src="https://demo3.rusoft.in/public/qrcode_voice/duplicatePunch.mp3" type="audio/ogg">
</audio>
