    ...
    <div class="card card-outline card-orange">
        ...
        <form action="{{ url('staff_attendance_add') }}" method="post">
                ...
                @if(empty($current_date))
                     <div class="text-center"><button type="submit" class="btn btn-primary" id="submitButton" >{{ __('staff.Submit Attendance') }}</button></div>
                @endif
                @else
                     <div class="text-center"><button type="submit" class="btn btn-primary" id="submitButton" >{{ __('staff.Submit Attendance') }}</button></div>
...
function autoStaffAttendance() {
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                url: 'autoStaffAttendance',
                type: 'POST',
                data: {
                    date: dateOfEvent,
