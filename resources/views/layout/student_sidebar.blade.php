...
<style>
    /* New Css Start */
      ...
      .elevation-4{
       background-color:#ced4e5 !important;
...
$admission = DB::table('admissions')->whereNull('deleted_at')->find(Session::get('id'));
@endphp

@if(!empty($admission->student_profile_update) && $admission->student_profile_update !== 'no')
