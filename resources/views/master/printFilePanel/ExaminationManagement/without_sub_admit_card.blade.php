        ...
        @foreach($data as $key => $item)
            <div class="card @if(in_array($key, [3, 7, 11, 15, 19, 23, 27, 31, 35, 39])) print-page-break @endif">
                    ...
                    <tr>
                        <td colspan="12">
                            @if(Session::get('branch_id') == 1)
                                <img class="img" src="{{ env('IMAGE_SHOW_PATH').'/default/KIDS_logo.jpg' }}">
                            @else
                                <img class="img" src="{{ env('IMAGE_SHOW_PATH').'/default/Senior.jpg' }}">
                            @endif
                        </td>
                    </tr>
                    <tr>
                        <td colspan="12">
                            <p style='text-align:center; font-weight:600; line-height:20px; font-size:15px; margin: 0px;'>
                                <u> Permission Card {{$session->from_year ?? ''}} - {{$session->to_year ?? ''}} </u>
                            </p>
                        </td>
                    </tr>
                </table>
                ...
                <table>
                    ...
                    <tr>
                        <td style="font-size: 14px;font-weight: bold;">
                            &nbsp; Note: Loss of permission card requires re-issuance by paying Rs. 50
                        </td>
                    </tr>
                </table>
