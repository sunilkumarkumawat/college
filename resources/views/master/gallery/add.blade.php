        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-outline card-orange">
                    ...
                    <h3 class="card-title"><i class="fa fa-image"></i> &nbsp; {{ __('master.Add Gallery') }}</h3>
                ...
                <form id="quickForm" action="{{ url('gallery_add') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row m-2" id="box2">
         <div class="col-md-2 ">
                           <div class="form-group">
                              <label class="text-danger">{{ __('Type') }}*</label>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('img_category') is-invalid @enderror" id="img_category" name="img_category" value="{{old('img_category')}}" placeholder="{{ __('master.Image category') }}">
                                @error('img_category')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                               ...
                               <input type="file" class="form-control @error('photo') is-invalid @enderror" id="photo" name="photo[]" multiple value="{{old('photo')}}"  accept="image/png, image/jpg, image/jpeg">
