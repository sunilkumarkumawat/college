                        ...
                        <input type="hidden" name="class_type_id" value="{{$search['class_type_id'] ?? ''}}" />
                           <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                  ...
                                  @php
                                     $checkbox = DB::table('all_subjects')->where('session_id',Session::get('session_id'))->where('branch_id',Session::get('branch_id'))->where('deleted_at',null)->get();
                                     @endphp
                                     
                                     @foreach($checkbox as $item)
                                     
                                       @php
                                     $subject = DB::table('subject')->where('session_id',Session::get('session_id'))->where('name',$item->name)-> where('class_type_id',$search['class_type_id'])->where('deleted_at',null)->first();
                                     @endphp
                               <div class="row">
                             <div class="col-md-2 ">
                                  <input type="checkbox" 
