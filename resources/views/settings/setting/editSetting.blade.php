...
<div class="col-md-1 mt-4">
	<img src="{{ env('IMAGE_SHOW_PATH').'/setting/principal_sign/'.$data['principal_sign'] }}" width="40px" height="40px" onerror="this.src='{{ env('IMAGE_SHOW_PATH').'default/no_image.png' }}'">
</div>
...
<div class="col-md-1 mt-4">
	<img src="{{ env('IMAGE_SHOW_PATH').'/setting/exam_sign/'.$data['exam_sign'] }}" width="40px" height="40px" onerror="this.src='{{ env('IMAGE_SHOW_PATH').'default/no_image.png' }}'">
</div>
...
<div class="col-md-1 mt-4">
	<img src="{{ env('IMAGE_SHOW_PATH').'/setting/treasurer_sign/'.$data['treasurer_sign'] }}" width="40px" height="40px" onerror="this.src='{{ env('IMAGE_SHOW_PATH').'default/no_image.png' }}'">
</div>
    ...
    <div class="d-flex flex-wrap m-1">
        ...
        @if(!empty($list))
            @foreach($list as $item)
                <div class="village-item pl-1 pr-1 d-flex align-items-center bg-white mr-2 mb-1" style='border:1px solid #d8d8d8; border-radius:4px; padding:4px 8px;'>
                    <span class='mr-2'>{{ $item->name ?? '' }}</span>

                    <form method='post' action='{{ url("deleteVillageList") }}' onsubmit="return confirm('Are you sure to delete this village?')">
                        @csrf
                        <input type='hidden' name='delete_id' value='{{ $item->id }}' />
                        <button class="btn text-danger btn-sm deleteBtn" type="submit">&times;</button>
                    </form>
                </div>
            @endforeach
        @endif
