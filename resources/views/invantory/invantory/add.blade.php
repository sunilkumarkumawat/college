...
<div class="content-wrapper">
   ...
   <section class="content pt-3">
    ...
    <div class="card card-outline card-orange">
            ...
            <h3 class="card-title"><i class="fa fa-address-book-o"></i> &nbsp;{{ __(' Inventory Add') }} </h3>
            ...
            <form id="quickForm" action="{{ url('invantory_add') }}" method="post" enctype="multipart/form-data">
            @csrf
                <div class="row m-2">
                    <div class="col-md-2">
                     ...
                     <div class="col-md-2">
                        ...
                        <label for="inputEmail3" style="color:red;"> Invoice/Bill No.*</label>
                         <input type="text" class="form-control @error('invoice_no') is-invalid @enderror" autofocus="autofocus" id="invoice_no"  name="invoice_no"  value="" placeholder="Invoice No." >
        					@error('invoice_no')
        						<span class="invalid-feedback" role="alert">
        							<strong>{{ $message }}</strong>
        						</span>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <span class="input-group-append">
                                <input id="party_name1" type="text" class="form-control"  name="party_name"  value="{{old('party_name') ?? ''}}" placeholder="Party Name" style="height: 35px;" required>
                    ...
                    <div class="col-md-3">
                            <div class="form-group ">
                                <label style="color:red;"> Mobile*</label>
                                 <input type="text"  class="form-control @error('mobile') is-invalid @enderror" id="mobile"  name="mobile" value="{{old('mobile')}}" placeholder="Mobile"  onkeypress="javascript:return isNumber(event)">
                                @error('mobile')
            						<span class="invalid-feedback" role="alert">
            							<strong>{{ $message }}</strong>
            						</span>
                    ...
                    <div class="col-md-2">
                            <div class="form-group ">
                                <label> GSTIN</label>
                                 <input type="text"  class="form-control @error('gstin') is-invalid @enderror" id="gstin" tabindex="1" name="gstin" value="{{old('gstin')}}" placeholder="GSTIN"  >
                                @error('gstin')
            						<span class="invalid-feedback" role="alert">
            							<strong>{{ $message }}</strong>
            						</span>
                  ...
                  <tbody id ="tbodynew">
                    ...
                    <td>
                        <div class="form-group" style="width: 8pc;">
                            <input name="qty[]" id="qty_0" placeholder="Quantity" class="form-control qty" required onblur="calcSum(this.value,0)" maxlength="100" type="text"  value="{{ old('quantity') }}" onkeypress="javascript:return isNumber(event)">
                	   </div>
                    </td>
                   <td>
                        <div class="form-group">
                    ...
                    <td>
                        <div class="form-group" style="width: 8pc;">
                            <input name="tax[]" id="tax_0" placeholder="Tax" class="form-control tax" required onblur="calcSum(this.value,0)" maxlength="100" type="text"  value="{{ old('tax') }}" onkeypress="javascript:return isNumber(event)">
                	   </div>
                    </td>
                  <!--  <td>
                        <div class="form-group" style="width: 8pc;">
