          ...
          <div class="col-12 col-md-12">
            <div class="card card-outline card-orange">
                <div class="card-header bg-primary">
                    <h3 class="card-title"><i class="nav-icon fas fa fa-address-book-o"></i> &nbsp;{{ __('Registration Management') }}</h3>
            ...
            @if(!empty(Helper::SidebarSubPerm(27)))
                @foreach(Helper::SidebarSubPerm(27) as $sub_sidebar)
