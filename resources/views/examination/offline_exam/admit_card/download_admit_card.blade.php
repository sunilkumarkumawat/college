                              ...
                              <td>
                                    @if(!empty($exam_roll_no->exam_roll_no))
                                        <a href="{{url('single_exam_admit_card')}}/{{ $search['class_type_id'] ?? ''}}/{{ $search['exam_id'] ?? ''}}/{{ $item->id ?? ''}}" target="_blank">
                                             <button form="Form_{{$key}}" type="submit" class="btn btn-success btn-xs ml-3" title="View/Download">
                                        ...
                                        <a href="{{url('add/admit_card')}}">
                                             <button type="button" class="btn btn-success btn-xs ml-3" title="View/Download">
...
<button type="button"  data-class="{{ $search['class_type_id'] ?? ''}}" data-exam="{{ $search['exam_id'] ?? ''}}" 
                                                data-stream="{{ $search['stream_id'] ?? ''}}" id="quickForm_find2" class="btn btn-success">Without Subject Admit Card </button>
                                        </div>
